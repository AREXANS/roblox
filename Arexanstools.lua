...
task.spawn(function()
    ...
    local function InitializeMainGUI(expirationTimestamp)
		...
		local localPlayerIsHidden = false
        ...
        -- [[ PENAMBAHAN: Variabel untuk Fitur Rekaman (dari autoreplay.lua) ]]
		...
		local MiniToggleContainer = Instance.new("Frame")
		...
		MainFrame.Size = UDim2.new(0, 300, 0, 350) -- Lebar ditambah untuk tab rekaman
		MainFrame.Position = UDim2.new(0.5, -150, 0.5, -175) -- Posisi disesuaikan
		...
		ExpirationLabel.Position = UDim2.new(0, 0, 0, 30)
		...
		ContentFrame.Size = UDim2.new(1, -80, 1, -45)
		ContentFrame.Position = UDim2.new(0, 80, 0, 45)
        ...
        -- [[ PENAMBAHAN: Frame Konten Tab Rekaman ]]
        local RekamanTabContent = Instance.new("Frame")
        ...
        -- [[ PENAMBAHAN: Layout untuk Tab Rekaman ]]
        local RekamanContentLayout = Instance.new("UIListLayout", RekamanTabContent)
        RekamanContentLayout.Padding = UDim.new(0, 10)
        RekamanContentLayout.SortOrder = Enum.SortOrder.LayoutOrder
		...
		local function switchTab(tabName)
            ...
            RekamanTabContent.Visible = (tabName == "Rekaman") -- [[ PENAMBAHAN ]]
        ...
        local RekamanTabButton = createTabButton("Rekaman", TabsFrame) -- [[ PENAMBAHAN ]]
        ...
        -- [[ PENAMBAHAN: Bagian Fungsi Inti untuk Fitur Rekaman ]]
        -- ====================================================================
        -- == BAGIAN FUNGSI REKAMAN (INTEGRASI)                            ==
        -- ====================================================================
        
        local RekamanStatusLabel, RecordingsListFrame
        local updateRecordingsList -- Forward declaration

        local function startRecording()
            if isRecording then return end
            if isPlaying then RekamanStatusLabel.Text = "Tidak bisa merekam saat memutar ulang."; return end

            local char = LocalPlayer.Character
            local hrp = char and char:FindFirstChild("HumanoidRootPart")
            local humanoid = char and char:FindFirstChildOfClass("Humanoid")
            if not (hrp and humanoid) then RekamanStatusLabel.Text = "Karakter/Humanoid tidak ditemukan."; return end

            isRecording = true
            currentRecordingData = {}
            local startTime = tick()
            RekamanStatusLabel.Text = "Merekam... 🔴"
        ...
        function stopActions()
            if isRecording then
                ...
                if #currentRecordingData > 1 then
                    ...
                    RekamanStatusLabel.Text = "Rekaman disimpan sebagai: " .. newName
                    if updateRecordingsList then updateRecordingsList() end
                else
                    RekamanStatusLabel.Text = "Perekaman dibatalkan (terlalu singkat)."
                end
                currentRecordingData = {}
            end
            ...
            if isPlaying then
                ...
                RekamanStatusLabel.Text = "Pemutaran ulang dihentikan."
            end
        end

        function playRecording(replayCountBox)
            if isPlaying then return end
            if isRecording then RekamanStatusLabel.Text = "Hentikan perekaman terlebih dahulu."; return end
            if not loadedRecordingName or not savedRecordings[loadedRecordingName] then RekamanStatusLabel.Text = "Pilih rekaman untuk diputar."; return end
            ...
            if #recording < 2 then RekamanStatusLabel.Text = "Rekaman tidak valid."; return end
            ...
            RekamanStatusLabel.Text = string.format("Memutar: %s (%d/%s)", loadedRecordingName, currentLoop, tostring(replayCount) == "inf" and "∞" or replayCount)
            ...
            playbackConnection = RunService.Heartbeat:Connect(function()
                ...
                if elapsedTime > recordingDuration then
                    ...
                    if currentLoop > replayCount then
                        isPlaying = false 
                        RekamanStatusLabel.Text = "Pemutaran selesai."
                        return
                    end
                    loopStartTime = tick()
                    elapsedTime = 0
        ...
        updateRecordingsList = function()
            ...
            for _, recName in ipairs(sortedNames) do
                ...
                nameButton.MouseButton1Click:Connect(function()
                    ...
                    RekamanStatusLabel.Text = "Memuat: " .. recName
                        ...
                        Callback = function(action)
                            if action == "Button1" then
                                ...
                                if newName and newName ~= "" and not savedRecordings[newName] then
                                    ...
                                    RekamanStatusLabel.Text = "Nama diubah menjadi " .. newName
                                    updateRecordingsList()
                                else
                                    RekamanStatusLabel.Text = "Nama tidak valid atau sudah ada."
                                end
                            end
                        end,
                        TextBox = box
                ...
                deleteButton.MouseButton1Click:Connect(function()
                    ...
                    RekamanStatusLabel.Text = "Menghapus: " .. recName
                    updateRecordingsList()
                end)
            end
        end
		...
		local function initializeAnimationGUI()
			...
			pcall(function()
				...
				AnimationScreenGui.DisplayOrder = 10
				...
				task.spawn(function()
					...
					local activeButtonColor = Color3.fromRGB(28, 184, 88)
					...
					if head and char:FindFirstChild("Humanoid") and char.Humanoid.Health > 0 then
						...
						if IsEspNameEnabled then
							...
							if player.Team == localPlayerTeam and localPlayerTeam ~= nil then
								espElements.billboard.NameLabel.TextColor3 = Color3.fromRGB(100, 255, 100)
							else
								espElements.billboard.NameLabel.TextColor3 = Color3.fromRGB(100, 100, 255)
							end
						...
						if IsEspBodyEnabled then
							...
							if player.Team == localPlayerTeam and localPlayerTeam ~= nil then
								...
								espElements.highlight.FillColor = Color3.fromRGB(100, 100, 255)
							end
		...
		local function createSpectateLocationGUI()
			...
			JoystickBase.Image = "rbxassetid://392630590"
		...
		local function DisableAllFeatures()
            ...
            if isRecording or isPlaying then stopActions() end -- [[ PENAMBAHAN ]]
		end
        ...
        -- [[ PENAMBAHAN: Pengaturan Konten Tab Rekaman ]]
        ...
        ControlButtonsFrame.Parent = RekamanTabContent
        ...
        ReplayOptionsFrame.LayoutOrder = 2; ReplayOptionsFrame.Parent = RekamanTabContent
        ...
        RekamanStatusLabel = Instance.new("TextLabel")
        RekamanStatusLabel.Name = "StatusLabel"; RekamanStatusLabel.Size = UDim2.new(1, 0, 0, 20); RekamanStatusLabel.BackgroundTransparency = 1; RekamanStatusLabel.Font = Enum.Font.SourceSansItalic
        RekamanStatusLabel.Text = "Siap."; RekamanStatusLabel.TextColor3 = Color3.fromRGB(180, 180, 180); RekamanStatusLabel.TextSize = 12; RekamanStatusLabel.LayoutOrder = 3; RekamanStatusLabel.Parent = RekamanTabContent
        ...
        RecordingsListFrame.ScrollBarThickness = 6; RecordingsListFrame.ScrollBarImageColor3 = Color3.fromRGB(0, 150, 255); RecordingsListFrame.LayoutOrder = 4; RecordingsListFrame.Parent = RekamanTabContent
        ...
        -- Hubungkan tombol rekaman ke fungsi
		...
		local function toggleMainFrame()
			...
			if MainFrame.Visible then
				if not (PlayerTabContent.Visible or GeneralTabContent.Visible or CombatTabContent.Visible or TeleportTabContent.Visible or SettingsTabContent.Visible or VipTabContent.Visible or RekamanTabContent.Visible) then
					switchTab("Player")
				else
					updatePlayerList()
				end
		...
		createButton(SettingsTabContent, "Tutup", CloseScript).LayoutOrder = 7
	
		local logoutButton = createButton(SettingsTabContent, "Logout", HandleLogout)
		logoutButton.LayoutOrder = 8
    ...
    local function CreatePasswordPromptGUI(passwordData)
        ...
        PromptTitleLabel.Size = UDim2.new(1, 0, 1, 0)
        ...
        PromptTitleLabel.TextXAlignment = Enum.TextXAlignment.Center
